...
public partial class ImageBrowser : System.Web.UI.Page
{
    ...
    protected void SelectImage(object sender, EventArgs e)
    {
        ...
        OkButton.OnClientClick = "window.top.opener.CKEDITOR.dialog.getCurrent().setValueOf('info', 'txtUrl', encodeURI('" + "http://quantri.drthem.vn/" + ImageFolder + ImageList.SelectedValue.Replace("'", "\\'") + "')); window.top.close(); window.top.opener.focus();";
    }
    ...
    protected void ResizeImage(object sender, EventArgs e)
    {
        ...
        var image_foder = ConfigurationManager.AppSettings["Image_News_Path"] ?? "E:\\vhost\\cdn.islickdeals.com\\Images\\News\\";
